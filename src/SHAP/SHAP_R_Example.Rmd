...
A data set will be constructed with built-in relationships between the target and features.
...
distance_to_city_center <- runif(n, 0, 30)
...
```{r}
sv_force(lm_shp_viz, row_id = 1, fill_colors = c("firebrick1", "royalblue1"))
sv_waterfall(lm_shp_viz, row_id = 1, fill_colors = c("firebrick1", "royalblue1"))
```
...
```{r}
sv_force(xg_shp_viz, row_id = 1, fill_color = c("firebrick1", "royalblue1"))
sv_waterfall(xg_shp_viz, row_id = 1, fill_color = c("firebrick1", "royalblue1"))
```
